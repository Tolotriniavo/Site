		...
		<div class="row">
				...
				<div class="single_content_layout">
					<div class="item feature_news_item">
						<div class="item_img">
							<img  class="img-responsive" src="<?php echo base_url();?>assets/img/<?php echo $article[0]['photo'];?>" alt="Chania">
						</div><!--item_img--> 
							<div class="item_wrapper">
								<div class="news_item_title">
									<h1 style="color:black;"><?php echo $article[0]['titre'];?></h1>
								</div><!--news_item_title-->
								<div class="item_meta"><a href="<?php echo base_url();?>date-<?php echo $article[0]['dateParution'];?>.html"><?php echo $article[0]['dateParution'];?>,</a> by:<a href="<?php echo base_url();?>auteur-<?php echo $article[0]['idAuteur'];?>.html"><?php echo $article[0]['nomAuteur'];?></a></div>
                                    ...
                                    <div class="category_list">
                                        <a href="<?php echo base_url();?>categorie-<?php echo $article[0]['idCategorie'];?>.html"><?php echo $article[0]['nomCateg'];?></a>
                                    </div><!--category_list-->
							</div><!--item_wrapper-->	
